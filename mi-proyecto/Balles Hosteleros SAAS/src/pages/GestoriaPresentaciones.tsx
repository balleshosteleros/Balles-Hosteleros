...
} from "@/data/gestoria-presentaciones";
...
export default function GestoriaPresentaciones() {
  const location = useLocation();
  useEffect(() => { sessionStorage.setItem("gestoria_last", location.pathname); }, [location.pathname]);
