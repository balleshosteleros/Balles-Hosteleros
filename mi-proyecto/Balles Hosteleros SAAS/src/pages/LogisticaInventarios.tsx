...
import { getStockPorEmpresa, type ProductoStock } from "@/data/stock";
...
import InventarioModal from "@/components/inventarios/InventarioModal";
import DetalleInventario from "@/components/inventarios/DetalleInventario";
import InventarioConfigView from "@/components/inventarios/InventarioConfigView";

const ALL = "__ALL__";

export default function LogisticaInventarios() {
  const location = useLocation();
  useEffect(() => { sessionStorage.setItem("logistica_last", location.pathname); }, [location.pathname]);
