...
import {
  ...
  type ProcesoJuridico, type EstadoProceso, type GravedadProceso, type ActualizacionProceso, type DocumentoProceso,
} from "@/data/procesos-juridicos";
import { EstadoProcesoBadge, GravedadProcesoBadge } from "@/components/juridico/BadgesProceso";
import { DetalleProceso } from "@/components/juridico/DetalleProceso";
import { ProcesoModal } from "@/components/juridico/ProcesoModal";
...
import { Plus, Search, Scale, Info, FileText, Settings2, CalendarDays } from "lucide-react";

const ALL = "__ALL__";

export default function JuridicoProcesos() {
  const location = useLocation();
  useEffect(() => { sessionStorage.setItem("juridico_last", location.pathname); }, [location.pathname]);
