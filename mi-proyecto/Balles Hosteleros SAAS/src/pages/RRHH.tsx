...
function getKPIs(totalEmpleados: number, empresaId: string): KPI[] {
  ...
  return [
    {
      label: "Volumen de rotación",
      value: isHabana ? "12%" : "8%",
      subtitle: "Últimos 12 meses",
      icon: TrendingUp,
      trend: { value: isHabana ? "+2% vs anterior" : "-1% vs anterior", positive: !isHabana },
    },
    {
      label: "Onboarding",
      value: isHabana ? "3" : "1",
      subtitle: "Incorporaciones activas",
      icon: UserPlus,
      trend: { value: isHabana ? "2 esta semana" : "1 esta semana", positive: true },
    },
    {
      label: "Offboarding",
      value: isHabana ? "1" : "0",
      subtitle: "Salidas en curso",
      icon: UserMinus,
      trend: { value: isHabana ? "1 pendiente" : "Sin salidas", positive: !isHabana },
    },
    {
      label: "Salarios totales",
      value: isHabana ? "€38.500" : "€27.200",
      subtitle: "Nómina mensual bruta",
      icon: DollarSign,
      trend: { value: isHabana ? "+€1.200 vs mes ant." : "Sin variación", positive: false },
    },
    {
      label: "Incidencias de fichajes",
      value: isHabana ? "7" : "3",
      subtitle: "Pendientes de resolver",
      icon: AlertTriangle,
      trend: { value: isHabana ? "4 nuevas hoy" : "1 nueva hoy", positive: false },
    },
    {
      label: "Documentos pend. firma",
      value: isHabana ? "5" : "2",
      subtitle: "Contratos y anexos",
      icon: FileText,
      trend: { value: isHabana ? "2 urgentes" : "Sin urgentes", positive: false },
    },
  ];
}
...
export default function RRHH() {
  ...
  return (
    <div className="space-y-6">
      ...
      <AccesosDirectos departamento="RRHH" />
      ...
      {/* Bottom row: Estado + Departamentos */}
