...
import { getSalariosEmpresa, PuestoSalarial, NormaSalarial, DEPARTAMENTOS_DISPONIBLES } from "@/data/salarios";
...
export default function RRHHSalarios() {
  ...
  return (
    <div className="space-y-6">
      ...
      {grouped.map(([depto, items]) => {
        const open = expanded[depto] !== false; // default open
        return (
          <Card key={depto}>
            <button
