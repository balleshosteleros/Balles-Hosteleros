...
import {
  ...
  BarChart3, Eye, Calendar, CheckCircle2, Clock, Info,
} from "lucide-react";
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {(["todos", "activo", "borrador", "inactivo", "archivado"] as const).map((f) => (
          <Button key={f} size="sm" variant={filtro === f ? "default" : "outline"} onClick={() => setFiltro(f)}>
            {f === "todos" ? "Todos" : ESTADO_BONUS_LABEL[f]}
          </Button>
        ))}
      </div>
...
/* ================================================================
   TAB: VER DETALLES (read-only, informativo)
   ================================================================ */
...
/* ================================================================
   TAB: CONFIGURACIÓN (edición admin)
   ================================================================ */
...
/* ================================================================
   DETALLE BONUS (orquestador con 3 pestañas)
   ================================================================ */
...
/* ================================================================
   PÁGINA PRINCIPAL
   ================================================================ */
export default function RRHHBonus() {
