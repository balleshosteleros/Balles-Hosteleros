...
import { getEmpleadosPorEmpresa, ESTADOS_LABEL, ESTADOS_COLOR, EstadoEmpleado } from "@/data/rrhh";
        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent border-b">
              ...
              <TableHead className="min-w-[200px] text-xs font-medium text-muted-foreground tracking-wide">Empleado</TableHead>
              <TableHead className="text-xs font-medium text-muted-foreground tracking-wide text-center">Estado</TableHead>
              <TableHead className="text-xs font-medium text-muted-foreground tracking-wide text-center">Horario</TableHead>
              <TableHead className="text-xs font-medium text-muted-foreground tracking-wide text-center">Horas hoy</TableHead>
              <TableHead className="text-xs font-medium text-muted-foreground tracking-wide text-center">Departamentos</TableHead>
              <TableHead className="text-xs font-medium text-muted-foreground tracking-wide text-center">Teléfono</TableHead>
              <TableHead className="text-xs font-medium text-muted-foreground tracking-wide text-center">Fichajes</TableHead>
              <TableHead className="text-xs font-medium text-muted-foreground tracking-wide">Email de empresa</TableHead>
              <TableHead className="text-xs font-medium text-muted-foreground tracking-wide text-center">Email personal</TableHead>
              <TableHead className="text-xs font-medium text-muted-foreground tracking-wide">Primer validador de fichajes</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {filtrados.map((emp) => (
              <TableRow key={emp.id} className="cursor-pointer h-16 border-b last:border-0" onClick={() => navigate(`/rrhh/empleados/${emp.id}`)}>
                ...
                <TableCell className="text-center"><span className="text-sm font-bold text-foreground tracking-wide">{emp.departamento}</span></TableCell>
