...
import { getFichaEmpleado } from "@/data/empleados-ficha";
import { FichaEmpleadoHeader } from "@/components/empleados/FichaEmpleadoHeader";
import {
...
export default function FichaEmpleadoPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <FichaEmpleadoHeader empleado={empleado} onBack={() => navigate("/rrhh/empleados")} onSave={handleSave} />
