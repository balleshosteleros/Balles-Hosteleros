...
import { TIPO_JORNADA_LABELS, ESTADO_PUBLICACION_LABELS, type TipoJornada, type EstadoPublicacion } from "@/data/reclutamiento";
              ...
              <TableRow key={r.id} className="cursor-pointer hover:bg-muted/50" onClick={() => handleEdit(r)}>
                ...
                <TableCell>
                  <Badge variant="outline" className="text-[10px]">
                    {ESTADO_PUBLICACION_LABELS[r.vacante.estadoPublicacion]}
                  </Badge>
                </TableCell>
                <TableCell>
