...
import { Contacto } from "@/data/ajustes";
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          <ContactField label="Instagram" value={c.instagram} onChange={(v) => set("instagram", v)} icon={Instagram} />
          <ContactField label="Facebook" value={c.facebook} onChange={(v) => set("facebook", v)} icon={Facebook} />
