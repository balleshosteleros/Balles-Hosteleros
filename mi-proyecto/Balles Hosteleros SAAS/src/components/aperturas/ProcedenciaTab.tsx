...
import { LineaProcedencia, ORIGENES_CAPITAL, OrigenCapital } from "@/data/aperturas";
...
export function ProcedenciaTab({ lineas, onChange }: Props) {
  ...
  const upd = (field: keyof LineaProcedencia, val: any) => setEditing(prev => prev ? { ...prev, [field]: val } : null);
