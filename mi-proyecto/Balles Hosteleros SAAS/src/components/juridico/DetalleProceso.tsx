...
import type { ProcesoJuridico, ActualizacionProceso, DocumentoProceso } from "@/data/procesos-juridicos";
import { JURIDICOS, CATEGORIAS_DOCUMENTO, type CategoriaDocumento } from "@/data/procesos-juridicos";
import { tiempoTranscurrido } from "@/lib/timeUtils";
