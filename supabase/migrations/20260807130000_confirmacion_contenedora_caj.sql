-- ============================================================
-- 20260807130000_confirmacion_contenedora_caj.sql
-- PRP-073 hotfix post-piloto (lote 07-ago): la lista de unidades CONTENEDORAS
-- de confirmar_albaran_transaccional no reconocía la abreviatura "CAJ" (la que
-- imprimen distribuidores como DDI Nexia), así que 2 cajas de 6 botellas
-- entraron al kardex como 2 unidades SIN avisar (ALB-2026-023 de HABANA,
-- detectado el 2026-08-07 y corregido re-confirmando con el formato "75CL 6U"
-- equivalencia 6). Se añaden 'caj', 'cajon/es' y 'box' a la lista; el resto de
-- la función queda IDÉNTICA a 20260804150000.
