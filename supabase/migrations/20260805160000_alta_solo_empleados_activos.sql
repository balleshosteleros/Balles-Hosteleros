-- Endurece la invitacion: solo cuentan los empleados ACTIVOS.
--
-- Un empleado dado de baja conserva su correo en la ficha historica, y eso
-- bastaba para crear cuenta. Caso real (2026-08-05): el Gmail personal de Ivan
-- figuraba como email_personal de la ficha INACTIVA de Adrian Paz, asi que su
-- alta por Google se permitio pese al bloqueo de la migracion anterior.
-- Verificado: los 25 usuarios reales siguen pasando la regla.
