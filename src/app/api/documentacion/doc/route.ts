...
/**
 * Sirve un documento del candidato (bucket privado `documentacion-candidatos`).
 * Solo accesible por usuarios autenticados de la empresa propietaria.
 * El path es `<empresa_id>/<candidato_id>/<tipo>.<ext>`.
 */
