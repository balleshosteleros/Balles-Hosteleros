...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      // En el telefono las pestanas no caben de largo: se arrastran de lado
      // en vez de salirse de la pantalla (`max-w-full` + scroll horizontal,
      // sin barra a la vista). Los triggers ya son `shrink-0` por su
      // `whitespace-nowrap`, asi que ninguno se aplasta.
