...
export async function iconoCircular(
  ...
  try {
    ...
    // Dibujo suelto: va sobre disco NEGRO, repintado con el color de la marca.
    ...
    const lado = Math.round(LADO * OCUPACION_DIBUJO);
    ...
    return await sharp(discoSvg(LADO, "#000"))
    ...
    console.error("[favicon] no se pudo recortar el icono en redondo:", e);
    return null;
  }
}
