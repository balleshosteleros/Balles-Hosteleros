...
const habanaChart: OrgChart = {
  nodes: [
    ...
    { id: 'camareros', label: 'CAMARERO', area: 'operativa', x: 320, y: 630 },
    { id: 'cachimberos', label: 'CACHIMBERO', area: 'operativa', x: 500, y: 630 },
  ...
  edges: [
    ...
    { id: 'e18', source: 'jefe-sala', target: 'camareros' },
    { id: 'e19', source: 'jefe-sala', target: 'cachimberos' },
    { id: 'e21', source: 'jefe-cocina', target: 'cocineros' },
    { id: 'e22', source: 'jefe-cocina', target: 'office' },
  ],
  zones: [
...
const bacanalChart: OrgChart = {
  nodes: [
    ...
    { id: 'camareros', label: 'CAMARERO', area: 'operativa', x: 320, y: 520 },
