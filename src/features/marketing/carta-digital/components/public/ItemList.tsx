...
function CategoryHeader({
  ...
  total: number;
  /**
   * Solo llega con texto en la carta abierta DESDE LA WEB y cuando ahora mismo
   * no se sirve ("Se sirve de lunes a viernes, de 12:30 a 16:30"). Sin esta
   * frase, enseñar la categoría fuera de su hora sería la promesa falsa que la
   * ventana horaria venía a evitar. En la mesa nunca hay aviso: allí la
   * categoría directamente no aparece.
   */
  horario: string | null;
}) {
