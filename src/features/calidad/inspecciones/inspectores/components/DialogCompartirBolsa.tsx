...
export function DialogCompartirBolsa({
  open, onOpenChange,
      ...
      <DialogContent className="sm:max-w-2xl">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Compartir la bolsa de inspectores
          </DialogTitle>
          <DialogDescription>
            Tres formas de añadir la bolsa de {empresaNombre} a tu web, redes o cualquier sitio.
          </DialogDescription>
        </DialogHeader>
        ...
        <Tabs defaultValue="link" className="mt-2">
          ...
          <TabsContent value="iframe" className="space-y-3 mt-4">
            <div className="space-y-1.5">
              ...
              <p className="text-[11px] text-muted-foreground">
                Pégalo en tu HTML donde quieras que aparezca la bolsa. Funciona en cualquier web.
              </p>
            </div>
          </TabsContent>
