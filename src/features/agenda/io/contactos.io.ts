...
export const agendaContactosIO: ModuleIO<Contacto> = {
  ...
  columns: [
    ...
    { key: "telefono", label: "Móvil", aliases: ["tlf", "telefono", "teléfono"], unique: true, example: "612345678" },
    { key: "telefono_fijo", label: "Teléfono fijo", aliases: ["fijo"], example: "916918911" },
