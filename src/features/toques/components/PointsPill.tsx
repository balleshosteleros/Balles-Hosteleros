...
export function PointsPill({ inicial = null, href = "/m/points", className }: Props) {
  ...
  const boton = (
    <button
      ...
      className={cn(
        // El alto lo pone `PILDORA_CABECERA`, el mismo de todas las pastillas
        // de arriba: borde, 4px de aire y dentro una pieza de 36 —aquí la
        // insignia, allí el isotipo y la foto—. Con el alto que traía (40px) el
        // círculo salía pegado al borde, metido a presión, y la pastilla era
        // más baja que sus vecinas (Iván, 13-sep).
...
function Insignia({
  ...
  return (
    // La insignia ENTERA mide 36px —aro de progreso incluido—, exactamente lo
    // mismo que el isotipo de la empresa y la foto del trabajador de al lado:
    // todas las pastillas de la cabecera llevan 4px de aire alrededor de una
    // pieza de 36. La chapa de color va dentro (32px) y el aro de 2px la rodea.
    <span
      className={cn(
