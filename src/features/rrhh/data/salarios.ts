...
const PUESTOS_BACANAL: PuestoSalarial[] = [
  ...
  },
  {
    ...
    objetivos: ["Control de costes de materia prima < 30%", "Cumplir escandallos al 100%", "Formación continua del equipo"],
    estado: "activo",
    updatedAt: "2025-02-01",
  },
  {
...
const PUESTOS_HABANA: PuestoSalarial[] = [
  ...
  },
  {
    ...
    objetivos: ["Control de costes < 30%", "Escandallos al 100%"],
    estado: "activo",
    updatedAt: "2025-01-15",
  },
  {
