...
export function CalendarioConfig({ modalidad, onBack }: { modalidad: string; onBack: () => void }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Antes había aquí una tanda de interruptores y campos (tipos, estados,
          aprobación, duración, visibilidad, avisos) que no guardaban nada: eran
          valores fijos de un fichero de ejemplo. Lo que de verdad se configura
          vive en Tipos de ausencia, y a eso se apunta. */}
      {modalidad !== "festivos" && (
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm">Ajustes de esta ausencia</CardTitle>
            <CardDescription className="text-xs">
              Los días máximos al año, si requiere justificante y si descuenta
              jornada se configuran en RRHH → Horarios → Configuración → Tipos
              de ausencia.
            </CardDescription>
          </CardHeader>
        </Card>
