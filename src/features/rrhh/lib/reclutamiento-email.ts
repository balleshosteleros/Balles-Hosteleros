...
export const VARIABLES_RECLUTAMIENTO: VariableReclutamiento[] = [
  ...
  { variable: "{{documentacion_dias_validez}}", descripcion: "Días que el enlace de documentación permanece válido (7; solo plantilla Documentación)", grupo: "Candidato" },
  ...
  { variable: "{{gestoria_datos}}", descripcion: "Tabla con los datos del trabajador para la gestoría (plantillas de gestoría: alta, baja y cambio de puesto)", grupo: "Candidato" },
  { variable: "{{tipo_baja}}", descripcion: "Tipo de baja: voluntaria, disciplinaria, etc. (solo plantilla «Gestoría · baja de trabajador»)", grupo: "Candidato" },
  { variable: "{{fecha_baja}}", descripcion: "Último día efectivo de trabajo del empleado (solo plantilla «Gestoría · baja de trabajador»)", grupo: "Candidato" },
  { variable: "{{fecha_baja_oficial}}", descripcion: "Día oficial de la baja = último día de trabajo + 1 (solo plantilla «Gestoría · baja de trabajador»)", grupo: "Candidato" },
...
export const VARIABLES_RECLUTAMIENTO_EJEMPLO: Record<string, string> = {
  ...
  tipo_baja: "Baja voluntaria",
  fecha_baja: "31/07/2026",
  fecha_baja_oficial: "01/08/2026",
