...
export const CLAVES_ONBOARDING = {
  ...
  gestoriaModelosAnual: "gestoria_modelos_anual",
...
export const NOMBRES_ONBOARDING: Record<ClaveOnboarding, string> = {
  ...
  gestoria_modelos_anual: "Gestoría · Solicitud modelos anuales",
...
> = {
  ...
  gestoria_modelos_anual: { destino: "departamento", destinoEmail: "correoGestoria" },
