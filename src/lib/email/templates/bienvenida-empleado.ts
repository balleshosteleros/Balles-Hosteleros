            ...
            <tr>
              <td style="padding:16px 32px 24px 32px;border-top:1px solid #e2e8f0;">
                <p style="margin:0;font-size:11px;color:#94a3b8;line-height:1.5;">
                  Este enlace caduca en 7 días y solo puede usarse una vez. Si no
...
Tu cuenta en ${opts.empresaNombre} ya está lista. Para empezar, elige tu contraseña con este enlace (caduca en 7 días y solo puede usarse una vez):
${opts.actionUrl}
