...
| D — Deuda y cierre ✅ **EJECUTADA 2026-08-06** (F6: recepción por extractor único + comparador versionado, cero `functions.invoke`, probado E2E; tabla muerta `albaranes_lineas` dropeada; F7 rebajado según lo acordado: E2E manuales + typecheck/lint/deploy como gates). **PRP-073 COMPLETO.** | F6 → F7 | Sin llamadas a la Edge Function no versionada; gates finales del PRP. ⚠️ F6 toca la recepción que Iván usa a diario: avisar y elegir ventana. |
