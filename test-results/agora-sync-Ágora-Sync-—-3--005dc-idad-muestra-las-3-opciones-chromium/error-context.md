...
- Name: agora-sync.spec.ts >> Ágora Sync — 3. AgoraSyncStatus refleja el cambio de estado >> ante error, el diálogo de seguridad muestra las 3 opciones
- Location: tests/agora-sync.spec.ts:269:7
