...
- Name: agora-sync.spec.ts >> Ágora Sync — 3. AgoraSyncStatus refleja el cambio de estado >> el componente muestra el estado del último sync tras el trigger
- Location: tests/agora-sync.spec.ts:234:7
