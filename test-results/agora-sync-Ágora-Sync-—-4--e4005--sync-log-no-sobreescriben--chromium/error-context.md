...
- Name: agora-sync.spec.ts >> Ágora Sync — 4. Integridad completa de la tubería >> múltiples triggers acumulan registros en agora_sync_log (no sobreescriben)
- Location: tests/agora-sync.spec.ts:340:7
