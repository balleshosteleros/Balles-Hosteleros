...
- Name: agora-sync.spec.ts >> Ágora Sync — 3. AgoraSyncStatus refleja el cambio de estado >> opción 'Ignorar' cierra el diálogo y muestra toast informativo
- Location: tests/agora-sync.spec.ts:288:7
