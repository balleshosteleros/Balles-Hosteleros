...
- Name: agora-sync.spec.ts >> Ágora Sync — 3. AgoraSyncStatus refleja el cambio de estado >> el componente muestra la fecha del último sync
- Location: tests/agora-sync.spec.ts:257:7
