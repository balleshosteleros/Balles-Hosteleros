...
- Name: agora-sync.spec.ts >> Ágora Sync — 2. Registro en agora_sync_log >> el registro tiene status válido ('ok' | 'partial' | 'timeout' | 'error')
- Location: tests/agora-sync.spec.ts:173:7
