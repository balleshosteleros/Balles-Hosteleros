...
- Name: agora-sync.spec.ts >> Ágora Sync — 3. AgoraSyncStatus refleja el cambio de estado >> opción 'Backup' cierra el diálogo y confirma que el log fue guardado
- Location: tests/agora-sync.spec.ts:311:7
