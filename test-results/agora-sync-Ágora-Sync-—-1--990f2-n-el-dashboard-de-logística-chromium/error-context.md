...
- Name: agora-sync.spec.ts >> Ágora Sync — 1. Trigger de sincronización >> el botón 'Sincronizar' está visible en el dashboard de logística
- Location: tests/agora-sync.spec.ts:94:7
