...
- Name: agora-sync.spec.ts >> Ágora Sync — 1. Trigger de sincronización >> al pulsar el botón entra en estado loading (no se queda colgado)
- Location: tests/agora-sync.spec.ts:102:7
