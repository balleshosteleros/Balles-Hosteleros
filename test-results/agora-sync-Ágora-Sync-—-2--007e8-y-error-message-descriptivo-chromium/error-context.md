...
- Name: agora-sync.spec.ts >> Ágora Sync — 2. Registro en agora_sync_log >> sin AGORA_API_URL, el registro tiene status='error' y error_message descriptivo
- Location: tests/agora-sync.spec.ts:190:7
