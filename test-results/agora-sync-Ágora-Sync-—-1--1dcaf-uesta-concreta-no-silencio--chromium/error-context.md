...
- Name: agora-sync.spec.ts >> Ágora Sync — 1. Trigger de sincronización >> tras el trigger, aparece una respuesta concreta (no silencio)
- Location: tests/agora-sync.spec.ts:118:7
